...
class Registration extends  StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child:Text('Create\n Your Account',style: TextStyle(fontSize:32,color:Colors.white,fontWeight: FontWeight.bold),), 
        ),),
        ...
        child:Container(
          ...
          child:Column(
            ...
            children: [
              Padding(padding: EdgeInsets.only(top:20.0,left:18.0,right:18.0),
               child:  TextField(
               ...
               child:  TextField(
                  decoration:InputDecoration(
                    suffixIcon: Icon(Icons.check,color: Color.fromARGB(217, 136, 5, 250),),
                    label:Text('Gmail',style:TextStyle(fontWeight: FontWeight.bold,color:Color.fromARGB(217, 136, 5, 250),
                    ),)
                  )
                ),),
                Padding(padding: EdgeInsets.only(top:20.0,left:18.0,right:18.0),
               ...
               child:  TextField(
                  decoration:InputDecoration(
                    suffixIcon: Icon(Icons.password_sharp,color: Color.fromARGB(217, 136, 5, 250),),
                    label:Text('Confirm Password',style:TextStyle(fontWeight: FontWeight.bold,color:Color.fromARGB(217, 136, 5, 250),
                    ),)
                  )
                ),),
                 SizedBox(height:20),
